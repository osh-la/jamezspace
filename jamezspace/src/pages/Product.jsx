...
import Iphone from '/iphone1.png'
...
const Product = () => {
  ...
  return (
    <section className="font-family:'SF_Pro_Display-Bold',Helvetica] p-2 md:mx-20">
            ...
            <div className="grid grid-cols-3 gap-1 mb-5 md:mb-0">
            ...
            <div className='grid md:grid-cols-3 gap-2  md:m-10'>
            <section className='md:col-span-2'>
                ...
                <section >
                    <div className="w-full ">
                        <img className="w-full bg-gray-200 rounded-xl"src={Iphone} alt="image" />
                     </div>
            ...
            <section className="md:col-span-1 text-sm md:text-base">
                ...
                <Card>
                    ...
                    <div className="flex gap-2 p-2">
                        <img className='rounded-full w-16 h-16 'src='/user.png' alt="" />
                        <div>
                            <h1>Name</h1>
                            <span>stars</span>
