...
const Product = () => {
    ...
    return (
        <section className="font-family:'SF_Pro_Display-Bold',Helvetica] p-2 md:mx-20">
            ...
            <div className="grid grid-cols-3 gap-2 mb-5 md:mb-0">
            ...
            <div className='grid md:grid-cols-3 gap-3 mt-10 '>
                <section className='md:col-span-2'>
                    ...
                    <section >
                        ...
                        <div className="flex gap-2 mt-4  w-full ">
                            <img className="w-1/3 h-40  object-contain bg-gray-200 rounded-xl" src={Iphone} alt="image" />
                            <img className="w-1/3 h-40 object-contain bg-gray-200 rounded-xl" src="/iphone3.png" alt="image" />
                        </div>
                        <div className="border-b-2 border-gray-100 py-4 md:py-6">
                            <div className="flex justify-between">
                                <div className="">
                                    <h1 className="md:text-3xl font-bold">iphone 14 pro max</h1>
                                    <h2 className="md:text-3xl font-bold">₦1,200,000</h2>
                                </div>
                                <div className="flex items-center md:gap-6">
                                    <Button bg='bg-orange-100' round="rounded-full">
                                        <p className="text-orange-500 px-4 text-sm md:text-base">Promoted</p>
                                    </Button>
                                    <img className="w-10 h-10" src="/icons/heart.svg" alt="" />
                                </div>

                            </div>

                            <div className=" hidden flex gap-2 text-sm">
                ...
                <section className="md:col-span-1 text-sm md:text-base">
                    <div className="bg-gray-100 border border-gray-200 shadow-custom md:border-none rounded-lg space-y-4 p-4 ">
                        ...
                        <button className='bg-white rounded-none  w-full mt-2 center p-4 text-sm hover:text-gray-100 border-2 border-green-200'  >Price History</button>
                    </div>
                    ...
                    <Card>
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                <div class="text-gray-900 text-2xl font-medium">OneRealGadget</div>
                                <div class="flex items-center gap-2">
                                    <span class="text-gray-600 text-xs">About 2yrs on JamezSpace</span>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <button class="w-full py-3 bg-green-600 text-white text-sm font-medium rounded-lg flex items-center justify-center gap-2">
                                <img className="w-5 h-5" src="/icons/Frame1.png" alt="" />  Contact Vendor
                            </button>

                            <button class="w-full py-3 bg-green-600 text-white text-sm font-medium rounded-lg flex items-center justify-center gap-2">
                                <img className="w-5 h-5" src="/icons/scan.png" alt="" /> Make an Offer
                            </button>
                        </div>
                    ...
                    <Card>
                        ...
                        <div class=" rounded-lg py-6 flex gap-4 mb-6">
                            <img class="w-14 h-14 rounded-full" src="/user.png" alt="Profile" />
                            <div class="flex flex-col flex-1 gap-2">
                                ...
                                <p class="text-gray-500 text-sm">
                                    Lorem ipsum dolor sit amet consectetur adipiscing elit arcu aliquam,
                                    leo neque lacinia sagittis venenatis nullam dictumst torquent. Lorem
                                    ipsum dolor sit amet consectetur adipiscing elit arcu aliquam, leo
                                    neque lacinia sagittis venenatis nullam dictumst torquent.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="bg-orange-400 rounded-lg space-y-4 p-6 m-2">
                        <img src="/lady.png" alt="Product Image" class=" object-contain  mb-4" />
